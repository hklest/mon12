...
public class ATOFmonitor  extends DetectorMonitor {
    ...
    public void createHistos() {
        ...
        occADC1D.setTitleX("Scintillator (Scintillator/layer");
    ...
    public void processEvent(DataEvent event) {
        ...
        if(event.hasBank("ATOF::adc")==true){
	    DataBank bank = event.getBank("ATOF::adc");
	    int rows = bank.rows();
